...
$(document).ready(function() {
	...
	$("#knife").click(function() {
		if(canOperate) {
			var newItem = "<div class='gifWrapper'><img src='images/manufactureYDW/bamboo.gif' alt=''></div>";
			...
			setTimeout(function() {
				...
				var newItem = "<div class='gifWrapper'><img src='images/manufactureYDW/openBamboo.png' alt=''></div>";
				$("body").append(newItem);
			}, 2000);
			setTimeout(function() {
