$(document).ready(function() {
	...
	$("#wood1").hover(function() {
		...
		$(".tipsContent").html("&emsp;&emsp;木头有的松软、有的粗硬，一般木头松软的易雕，粗硬沉重的难雕。<br>&emsp;&emsp;该木头高28厘米，直径14厘米。秋季采伐，阴干两年。木头形体平圆而直，树皮细匀，并无节疤或肿瘤突出。<br>&emsp;&emsp;注意：本次所选木雕成品高度约25厘米，直径约10厘米。");
		$(".tipsWrapper").css("visibility", "visible");
	},function(){$(".tipsWrapper").css("visibility", "hidden");})
	
	$("#wood2").hover(function() {
		$(".tipsTittle").html("2号木材-简介");
		$(".tipsContent").html("&emsp;&emsp;木头有的松软、有的粗硬，一般木头松软的易雕，粗硬沉重的难雕。<br>&emsp;&emsp;高28厘米，直径14厘米。夏季采伐，阴干一年。木头形体平圆而直，树皮细匀，有节疤突出。<br>&emsp;&emsp;注意：本次所选木雕成品高度约25厘米，直径约10厘米。");
		$(".tipsWrapper").css("visibility", "visible");
	},function(){$(".tipsWrapper").css("visibility", "hidden");})
	
	$("#wood3").hover(function() {
		$(".tipsTittle").html("3号木材-简介");
		$(".tipsContent").html("&emsp;&emsp;木头有的松软、有的粗硬，一般木头松软的易雕，粗硬沉重的难雕。<br>&emsp;&emsp;高24厘米，直径8厘米。冬季采伐，阴干一年。木头形体平圆而直，树皮细匀，并无节疤或肿瘤突出。<br>&emsp;&emsp;注意：本次所选木雕成品高度约25厘米，直径约10厘米。");
		$(".tipsWrapper").css("visibility", "visible");
	},function(){$(".tipsWrapper").css("visibility", "hidden");})
	
	$("#wood4").hover(function() {
		$(".tipsTittle").html("4号木材-简介");
		$(".tipsContent").html("&emsp;&emsp;木头有的松软、有的粗硬，一般木头松软的易雕，粗硬沉重的难雕。<br>&emsp;&emsp;高24厘米，直径8厘米。春季采伐，阴干半年。木头形体平圆而直，树皮细匀，有节疤突出。<br>&emsp;&emsp;注意：本次所选木雕成品高度约25厘米，直径约10厘米。");
		$(".tipsWrapper").css("visibility", "visible");
	},function(){$(".tipsWrapper").css("visibility", "hidden");})
	...
	$("#wood1").click(function() {
		...
		setTimeout(function() {
			...
			var newItem = "<img id='operateGIF' src='images/manufactureHYMD/operate2.gif' alt=''>";
			$("body").append(newItem);
		...
		setTimeout(function() {
			...
			var newBG = "url(images/manufactureHYMD/finishBG2.png)";
			$("body").css("background-image", newBG);
	...
	$("#wood3").click(function() {
		...
		$(".warnWrapper").css("border", "10px #CC4D4D solid");
		$(".warnTittle").html("很遗憾！选择错误");
		$(".warnContent").html("错误原因：太小了，做不了呀！");
		$(".fullScreen").css("visibility", "visible");
		setTimeout(function() {
			$(".fullScreen").css("visibility", "hidden");
		}, 1000);
	...
	$(".finish").click(function() {
		...
		$.ajax({
			...
			dataType: "text",
			data: {telephone: $telephone, id: "manufactureHYMD", progress: 100.00, addScore: 10},  
			error: function() {
				alert("saveError");
			}
		});
