...
$(function ($) {
  ...
  $.fn.blowup = function (attributes) {
    ...
    $element.mousemove(function (e) {
      ...
      var lensX = e.clientX - $options.width / 2;
      var lensY = e.clientY - $options.height / 2;

      // Relative coordinates of image
      var relX = e.clientX - this.offsetLeft;
      var relY = e.clientY - this.offsetTop;
     
      // Zoomed image coordinates 
      var zoomX = -Math.floor(relX / $element.width() * NATIVE_IMG.width - $options.width / 2);
      var zoomY = -Math.floor(relY / $element.height() / 2 * NATIVE_IMG.height - $options.height / 2);
