<?php 
	...
	$query = "select header , score, adventureHYMD, adventureXWKZ, adventureYDW, familiar, manufactureHYMD, manufactureXWKZ, manufactureYDW, testHYMDhistory, testHYMDcharacter, testHYMDmake, testXWKZhistory, testXWKZnowadays, testXWKZmake, testYDWhistory, testYDWnowadays, testYDWmake from user where telephone = '".$telephone."';";// SQL语句
